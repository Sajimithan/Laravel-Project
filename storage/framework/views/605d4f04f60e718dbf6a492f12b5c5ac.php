...
<?php endif; ?>
    ...
    <div class="mb-4">
        ...
        <input id="age" type="number" name="age" value="<?php echo e(old('age')); ?>" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
    </div>
    ...
    <div class="mb-4">
        ...
        <textarea id="health_conditions" name="health_conditions" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"><?php echo e(old('health_conditions')); ?></textarea>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\health-domain\resources\views/auth/register.blade.php ENDPATH**/ ?>